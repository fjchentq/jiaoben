...
public class main3 {
    ...
    public static void main(String[] args) throws  Exception {
        String keystoreFile = "C:\\Users\\ctq520\\Desktop\\备用缓存\\https\\3326173_hao321.ren.pfx";
        String keystorePass = "d1ML7X98";
        //设置可通过ip地址访问https请求
        ...
        String urlStr = "https://47.104.226.79/api/jurisdiction/demo";
