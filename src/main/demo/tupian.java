...
//			Integer MOVE = number.divide(olDnumber).intValue()*150;
    ...
    public static void main(String[] args) {
        ...
        String srcImgPath = "D:/ee60bb5155cfdfc9804b5ac1e512f16.png"; // 源图片地址
        String tarImgPath = "D:/ee60bb5155cfdfc9804b5ac1e512f161.png"; // 待存储的地址
        String waterMarkContent = "陈体强"; // 水印内容
		Color color = Color.GREEN; // 水印图片色彩以及透明度
//        Color color = new Color(107, 109, 106);
        new tupian().addWaterMark(srcImgPath, tarImgPath,
